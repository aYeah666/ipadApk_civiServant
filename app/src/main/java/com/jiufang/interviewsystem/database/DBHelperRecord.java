...
public class DBHelperRecord extends SQLiteOpenHelper {
    ...
    // 数据库名称
    private static final String DB_NAME = "record_info.db";
    // 数据库版本号
    private static final int DB_VERSION = 1;
    //数据表名
    public static final String DBTABLE = "recordInfo";
     ...
     * @return
     */
    public static boolean deleteDatabase_record(Context context) {
    ...
    public static void copyToSdCard(Context context) {
        ...
        try {
            ...
            fos = new FileOutputStream(Environment.getExternalStorageDirectory().getAbsolutePath() + "/copy_recordInfo.db");
            int len = 0;
